...
### English
UEP v5.0 provides a fully documented API based on **OpenAPI 3.1**, automatically generated through FastAPI.  
The platform includes modules for authentication, MLOps, manufacturing, medical analytics, supply chain, and cross-module operations.

### 日本語訳
UEP v5.0 は **OpenAPI 3.1** に基づく API ドキュメントを提供しており、FastAPI によって自動生成されています。  
認証、MLOps、製造、医療、物流、横断モジュールなど、多数の API が統合されています。

### Screenshot  
FastAPI による自動生成ドキュメント画面（主要 API 一覧）  
※ ここにあなたのスクリーンショットを貼ってください。

---

# 📚 Full Architecture Documentation (English + Japanese)

以下は、UEP v5.0 の **アーキテクチャ全体を英語 → 日本語で統一した完全版 README** です。
